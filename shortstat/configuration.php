 ...
 ******************************************************************************
 Database settings
 ******************************************************************************/
$SI_db['server']	= "mysql12.powweb.com";	// leave as localhost unless you know otherwise
$SI_db['username']	= "aj";	// The username used to acces your database
$SI_db['password']	= "greengreen";	// The password used to acces your database
$SI_db['database']	= "aj";	// The database where you would like to store the stats table
 ...
 ******************************************************************************/
$SI_display['sitename']		= "A+J Product Solutions";	// The full name of the site
$SI_display['siteshort']	= "AJ Homepage";			// Used to indicate hits to the homepage
$SI_display['collapse']		= false;			// Collapse browsers by version
$SI_display['version']		= 'v0.35b';			// ShortStat version
